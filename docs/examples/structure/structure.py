...
slide = slides.add_slide("Latency benchmarks", nrows=1, ncols=2, col_widths=["55%", "45%"])
slide.add_table({
...
slide = slides.add_slide("Methodology", nrows=1, ncols=1)
slide.add_text(
    "### Methodology\n\n"
...
slides.write("../../_static/title-sections-example.html")
